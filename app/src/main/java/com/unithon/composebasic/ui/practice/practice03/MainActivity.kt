package com.unithon.composebasic.ui.practice.practice03
...
import com.unithon.composebasic.ui.practice.practice03.ui.theme.ComposeBasicTheme
...
fun BoxContainer(modifier: Modifier = Modifier) {
    Box(
        ...
        propagateMinConstraints = false // 가장 작은 하위 View를 꽉 채움
    ) {
        // 늦게 선언한 순서대로 층층이 쌓음
...
fun DummyBox(modifier: Modifier = Modifier, color: Color? = null) {
    ...
    // color 가 값이 있으면 해당 값을 넣어주고 값이 없다면 Random값을 넣어주기
